...
#+RESULTS:
| m | Meeting | entry | (function (lambda nil (find-file (concat (file-name-directory (or (org-capture-get :original-file t) (org-capture-get :original-file))) meetings.org)) (end-of-buffer) (insert * %^{Meeting Title:} |
